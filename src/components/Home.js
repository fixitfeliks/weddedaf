        ...
        {imageLoaded ? (
          <div>
            ...
            <div className="AF-Col">
              ...
              <br></br>
              <br></br>
              <div className="MText MainFont">
                Dear friends and family<br></br>
              </div>
              <div className="SText MainFont">
                We're so excited that we get to share our big day with you, and
                we will be happy just to have your company! We decided to
                dedicate our registry to supporting our honeymoon. If you would
                like to contribute you can with as little or as much as you'd
                like. And if not, your presence on our big day is all we need!
              </div>
            </div>
            <br />
            <br />
